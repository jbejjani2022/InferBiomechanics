...
class TrainCommand(AbstractCommand):
    ...
    def register_subcommand(self, subparsers: argparse._SubParsersAction):
        ...
        subparser.add_argument('--history-len', type=int, default=50, help='The number of timesteps of context to show when constructing the inputs.')
        subparser.add_argument('--stride', type=int, default=5, help='The number of timesteps of context to show when constructing the inputs.')
