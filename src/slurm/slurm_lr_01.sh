...
python3 /home/users/jkaneda/InferBiomechanics/src/main.py train --model-type feedforward --checkpoint-dir "$GROUP_HOME/cvpr/checkpoint-$TIMESTAMP" --learning-rate 0.01 --dataset-home "$GROUP_HOME/data" --opt-type sgd  --epochs 25