...
python3 /home/users/jkaneda/InferBiomechanics/src/main.py train --model-type feedforward --checkpoint-dir "$GROUP_HOME/cvpr/checkpoint-$TIMESTAMP" --learning-rate 0.001 --dataset-home "$GROUP_HOME/data" --trial-filter gait walk